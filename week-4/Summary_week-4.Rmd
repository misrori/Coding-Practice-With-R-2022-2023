...
**Full path**
```{r}
write.table(diamonds, 'diamonds.csv', sep = ";")
write.table(diamonds, 'diamonds.txt', sep = "#")
write.table(diamonds, 'diamonds_with_extra_lines.txt', sep = ";")
